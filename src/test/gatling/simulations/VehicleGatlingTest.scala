...
class VehicleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Vehicle entity")
        ...
        .repeat(2) {
            ...
            .post("/api/vehicles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "brand":"SAMPLE_TEXT", "licensePlate":"SAMPLE_TEXT", "vehicleType":"SAMPLE_TEXT", "dateCreated":"2020-01-01T00:00:00.000Z", "dateLastAccessed":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
